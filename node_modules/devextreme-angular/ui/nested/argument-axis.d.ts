...
export declare class DxoArgumentAxisComponent extends NestedOption implements OnDestroy, OnInit {
    ...
    get aggregationInterval(): number | string | {
        days?: number;
        hours?: number;
        milliseconds?: number;
        minutes?: number;
    ...
    set aggregationInterval(value: number | string | {
        days?: number;
        hours?: number;
        milliseconds?: number;
        minutes?: number;
