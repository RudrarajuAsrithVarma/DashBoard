...
import { ContentReadyEvent, DisposingEvent, InitializedEvent, ItemClickEvent, ItemContextMenuEvent, ItemRenderedEvent, OptionChangedEvent, SelectionChangedEvent, SubmenuHiddenEvent, SubmenuHidingEvent, SubmenuShowingEvent, SubmenuShownEvent } from 'devextreme/ui/menu';
...
export declare class DxMenuComponent extends DxComponent implements OnDestroy, OnChanges, DoCheck {
     ...
     */
    get showFirstSubmenuMode(): string | {
        delay?: number | {
            hide?: number;
            show?: number;
        };
    ...
    set showFirstSubmenuMode(value: string | {
        delay?: number | {
            hide?: number;
            show?: number;
        };
    ...
    set showSubmenuMode(value: string | {
        delay?: number | {
            hide?: number;
            show?: number;
        };
     ...
     */
    dataSourceChange: EventEmitter<DataSource | DataSourceOptions | Store | null | string | Array<DevExpress.ui.dxMenuItem>>;
    /**
