/**
 * DevExtreme (esm/__internal/grids/grid_core/editing/module.js)
 * Version: 23.1.3
...
var EditingController = modules.ViewController.inherit(function() {
    ...
    var members = {
        ...
        getIndexByKey: (key, items) => gridCoreUtils.getIndexByKey(key, items),
        hasChanges(rowIndex) {
            var changes = this.getChanges();
            var result = false;
        ...
        publicMethods: () => ["addRow", "deleteRow", "undeleteRow", "editRow", "saveEditData", "cancelEditData", "hasEditData"],
        refresh() {
        ...
        _getRowIndicesForCascadeUpdating: (row, skipCurrentRow) => skipCurrentRow ? [] : [row.rowIndex],
