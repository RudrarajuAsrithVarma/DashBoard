/**
 * DevExtreme (esm/__internal/grids/grid_core/columns_view/module.js)
 * Version: 23.1.3
...
import columnStateMixin from "../../../../ui/grid_core/ui.grid_core.column_state_mixin";
...
var columnsViewMembers = {
    ...
    _isAltRow: row => row && row.dataIndex % 2 === 1,
    ...
    _getBodies: tableElement => $(tableElement).children("tbody").not(".dx-header").not(".dx-footer"),
    ...
    _needRenderCell: (columnIndex, columnIndices) => !columnIndices || columnIndices.indexOf(columnIndex) >= 0,
    ...
    _wrapTableInScrollContainer($table) {
    ...
    getVisibleColumnIndex: (columnIndex, rowIndex) => columnIndex,
