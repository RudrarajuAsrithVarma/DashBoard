...
var _module_core2 = require("./module_core");
...
var GroupingHelper = _module_core2.GroupingHelper.inherit(function() {
        ...
        if (expandedInfo.paths.length && groupCount - loadedGroupCount > 0) {
            ...
            ! function(that, options, expandedInfo, loadedGroupCount, groupLevel, data) {
                ...
                (0, _iterator.each)(expandedInfo.paths, (function(expandedItemIndex) {
                    ...
                    var loadOptions = {
                        ...
                        filter: (0, _module_utils.createGroupFilter)(expandedInfo.paths[expandedItemIndex], {
            ...
            ! function(that, options, expandedInfo, data) {
                ...
                (0, _iterator.each)(expandedInfo.paths, (function(_, expandedPath) {
                    expandedFilters.push((0, _module_utils.createGroupFilter)(expandedPath, {
                        group: options.isCustomLoading ? options.storeLoadOptions.group : groups
                    }))
                }));
                var filter = options.storeLoadOptions.filter;
                if (!options.storeLoadOptions.isLoadingAll) {
                    filter = _module_core.default.combineFilters([filter, _module_core.default.combineFilters(expandedFilters, "or")])
                }
                var loadOptions = (0, _extend.extend)({}, options.storeLoadOptions, {
                    requireTotalCount: false,
                    requireGroupCount: false,
                    group: null,
                    sort: groups.concat(_module_core.default.normalizeSortingInfo(options.storeLoadOptions.sort || [])),
                    filter: filter
                });
    ...
    return {
        ...
        changeRowExpand: function(path) {
            ...
            var groups = _module_core.default.normalizeSortingInfo(dataSource.group());
            if (groupInfo) {
        ...
        handleDataLoading: function(options) {
            ...
            var groups = _module_core.default.normalizeSortingInfo(storeLoadOptions.group || options.loadOptions.group);
            if (options.isCustomLoading || !groups.length) {
                return
            }
            if (options.remoteOperations.grouping) {
                var remotePaging = this._dataSource.remoteOperations().paging;
                storeLoadOptions.group = _module_core.default.normalizeSortingInfo(storeLoadOptions.group);
        ...
        handleDataLoadedCore: function(options, callBase) {
            var loadedGroupCount = _module_core.default.normalizeSortingInfo(options.storeLoadOptions.group || options.loadOptions.group).length;
            var groupCount = options.group ? options.group.length : 0;
            var totalCount;
            var expandedInfo = {};
            if (options.isCustomLoading) {
        ...
        refresh: function(options, operationTypes) {
            ...
            var oldGroups = _module_core.default.normalizeSortingInfo(that._group);
            var isExpanded;
            var groupIndex;
            ...
            if (group && options.remoteOperations.paging && operationTypes.reload) {
                return foreachExpandedGroups(that, (function(groupInfo) {
                    var groupCountQuery = loadGroupTotalCount(dataSource, {
                        filter: (0, _module_utils.createGroupFilter)(groupInfo.path, {
                    ...
                    var groupOffsetQuery = loadGroupTotalCount(dataSource, {
                        filter: (0, _module_core2.createOffsetFilter)(groupInfo.path, {
                            filter: storeLoadOptions.filter,
                            group: group
                        }, true),
