 ...
 */
"use strict";
var _uiGrid_core = require("../../../../ui/grid_core/ui.grid_core.focus");
...
_module_core.default.registerModule("focus", (0, _extend.extend)(true, {}, _uiGrid_core.focusModule, {
    extenders: {
        controllers: {
            data: function(Base) {
                return function(_Base$inherit) {
                    ...
                    _proto._calculateExpandedRowGlobalIndex = function(deferred, key, groupPath, group) {
                        var groupFilter = (0, _module_utils.createGroupFilter)(groupPath, {
                            group: group
                        });
                ...
                }(Base.inherit(_uiGrid_core.focusModule.extenders.controllers.data))
            }
        }
    }
}));
