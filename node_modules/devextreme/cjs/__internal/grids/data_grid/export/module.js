...
var _uiGrid_core = require("../../../../ui/grid_core/ui.grid_core.export");
...
var DataProvider = _class.default.inherit({
    ...
    _getGroupValue: function(item) {
        ...
        var value = _module_core.default.getDisplayValue(groupColumn, groupColumn.deserializeValue ? groupColumn.deserializeValue(key[groupIndex]) : key[groupIndex], data, rowType);
        var result = "".concat(groupColumn.caption, ": ").concat(_module_core.default.formatValue(value, groupColumn));
        if (summaryCells && summaryCells[0] && summaryCells[0].length) {
            result += " ".concat(_module_core.default.getGroupRowSummaryText(summaryCells[0], this._options.summaryTexts))
        }
        return result
    },
                ...
                switch (item.rowType) {
                    ...
                    case "totalFooter":
                        if (correctedCellIndex < itemValues.length) {
                            ...
                            if ((0, _type.isDefined)(value)) {
                                ...
                                result.value = _module_core.default.getSummaryText(value, this._options.summaryTexts)
                            } else {
                        ...
                        if (cellIndex < 1) {
                            ...
                            if (Array.isArray(summaryItems)) {
                                ...
                                for (var i = 0; i < summaryItems.length; i++) {
                                    value += (i > 0 ? isExcelJS ? "\n" : " \n " : "") + _module_core.default.getSummaryText(summaryItems[i], this._options.summaryTexts)
                                }
                                result.value = value
                            } else {
                                result.cellSourceData.value = void 0
                    ...
                    default:
                        ...
                        if (column) {
                            ...
                            var displayValue = _module_core.default.getDisplayValue(column, _value, item.data, item.rowType);
                            if (!isFinite(displayValue) || (0, _type.isDefined)(column.customizeText)) {
                                if (isExcelJS && (0, _type.isDefined)(column.customizeText) && column.customizeText === this._exportController._columnsController.getCustomizeTextByDataType("boolean")) {
                                    ...
                                    result.value = _module_core.default.formatValue(displayValue, column)
                                }
                            } else {
                                result.value = displayValue
                            }
...
var ExportController = _module_core.default.ViewController.inherit({}).inherit({
...
_module_core.default.registerModule("export", {
