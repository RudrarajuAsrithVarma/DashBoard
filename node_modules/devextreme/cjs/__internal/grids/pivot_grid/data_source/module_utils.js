/**
 * DevExtreme (cjs/__internal/grids/pivot_grid/data_source/module_utils.js)
 * Version: 23.1.3
...
function sortDimension(dataSource, loadOptions, dimensionName, getAscOrder) {
    ...
    (0, _module_widget_utils.foreachDataLevel)(dataSource[dimensionName], (function(item, index) {
...
function getSortingMethod(field, dataSource, loadOptions, dimensionName, getAscOrder) {
    ...
    var summaryCompare = summaryValueSelector && (0, _module_widget_utils.getCompareFunction)(summaryValueSelector);
    return function(a, b) {
...
function getFieldSummaryValueSelector(field, dataSource, loadOptions, dimensionName) {
    ...
    var sortBySummaryFieldIndex = (0, _module_widget_utils.findField)(loadOptions.values, field.sortBySummaryField);
...
function getSliceIndex(items, path) {
    ...
    if (pathValue.length) {
        (0, _module_widget_utils.foreachTree)(items, (function(items) {
            var item = items[0];
            var itemPath = (0, _module_widget_utils.createPath)(items).join(".");
