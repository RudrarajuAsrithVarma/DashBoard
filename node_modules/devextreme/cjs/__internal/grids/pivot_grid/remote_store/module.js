/**
 * DevExtreme (cjs/__internal/grids/pivot_grid/remote_store/module.js)
 * Version: 23.1.3
...
function getFiltersForExpandedDimension(options) {
    return (0, _module_widget_utils.getFiltersByPath)(options[options.headerName], options.path).concat((0, _module_widget_utils.getFiltersByPath)(options["rows" === options.headerName ? "columns" : "rows"], options.oppositePath || []))
}
