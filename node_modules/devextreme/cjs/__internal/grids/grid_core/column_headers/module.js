/**
 * DevExtreme (cjs/__internal/grids/grid_core/column_headers/module.js)
 * Version: 23.1.3
...
var columnHeadersModule = {
    ...
    views: {
        columnHeadersView: _module.ColumnsView.inherit(function() {
            ...
            var members = {
                ...
                _createRow: function(row) {
                    ...
                    if ("header" === row.rowType) {
                        ...
                        if (!this._isLegacyKeyboardNavigation()) {
                            (0, _module_accessibility.registerKeyboardAction)("columnHeaders", this, $row, "td", this._handleActionKeyDown.bind(this))
                        }
                    }
                    return $row
                },
