/**
 * DevExtreme (cjs/__internal/grids/grid_core/virtual_columns/module.js)
 * Version: 23.1.3
    ...
    var members = {
        ...
        _compileVisibleColumns: function(rowIndex, isBase) {
            ...
            if (rowCount > 1 && "number" === typeof rowIndex) {
                ...
                beginFixedColumns = (0, _module_core.createColumnsInfo)(columnsInfo, 0, beginFixedColumns.length)[rowIndex] || [];
                endFixedColumns = (0, _module_core.createColumnsInfo)(columnsInfo, visibleColumns.length - endFixedColumns.length, visibleColumns.length)[rowIndex] || [];
                visibleColumns = (0, _module_core.createColumnsInfo)(columnsInfo, startIndex, endIndex)[rowIndex] || []
            } else {
