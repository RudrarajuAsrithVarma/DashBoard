/**
 * DevExtreme (cjs/__internal/grids/grid_core/columns_controller/module.js)
 * Version: 23.1.3
...
var ColumnsController = function(_modules$Controller) {
    ...
    _proto._getFirstItems = function(dataSource) {
        ...
        if (dataSource && dataSource.items().length > 0) {
            groupsCount = _module_utils.default.normalizeSortingInfo(dataSource.group()).length;
    ...
    _proto._endUpdateCore = function() {
        !this._skipProcessingColumnsChange && (0, _module_utils2.fireColumnsChanged)(this)
    };
    _proto.init = function(isApplyingUserState) {
        ...
        if (this._isColumnsFromOptions) {
            (0, _module_utils2.assignColumns)(this, columns ? (0, _module_utils2.createColumnsFromOptions)(this, columns) : []);
            (0, _module_utils2.applyUserState)(this)
        } else {
            (0, _module_utils2.assignColumns)(this, this._columnsUserState ? (0, _module_utils2.createColumnsFromOptions)(this, this._columnsUserState) : this._columns)
        }(0, _module_utils2.addExpandColumn)(this);
        if (this._dataSourceApplied) {
            this.applyDataSource(this._dataSource, true, isApplyingUserState)
        } else {
            (0, _module_utils2.updateIndexes)(this)
        }
        this._checkColumns()
    };
    ...
    _proto.getColumnByPath = function(path, columns) {
        ...
        if (columnIndexes.length) {
            if (columns) {
                ...
                column = (0, _module_utils2.getColumnByIndexes)(this, columnIndexes)
            }
        }
        return column
    };
    ...
    _proto.applyDataSource = function(dataSource, forceApplying, isApplyingUserState) {
        ...
        if (!this._dataSourceApplied || 0 === this._dataSourceColumnsCount || forceApplying || this.option("regenerateColumnsByVisibleItems")) {
            if (isDataSourceLoaded) {
                if (!this._isColumnsFromOptions) {
                    var columnsFromDataSource = (0, _module_utils2.createColumnsFromDataSource)(this, dataSource);
                    if (columnsFromDataSource.length) {
                        (0, _module_utils2.assignColumns)(this, columnsFromDataSource);
            ...
            (0, _module_utils2.updateColumnChanges)(this, "columns");
            (0, _module_utils2.fireColumnsChanged)(this);
    ...
    _proto.resetColumnsCache = function() {
        ...
        (0, _module_utils2.resetBandColumnsCache)(this)
    };
        ...
        if (isColumnFixing) {
            for (var i = 0; i <= rowCount; i++) {
                ...
                for (var j = 0; j < visibleColumns.length; j++) {
                    ...
                    } else if (prevColumn && prevColumn.fixed && (0, _module_utils2.getFixedPosition)(this, prevColumn) !== (0, _module_utils2.getFixedPosition)(this, column)) {
                        if (!(0, _type.isDefined)(transparentColumnIndex)) {
                            transparentColumnIndex = j
                        }
                    } else {
    ...
    _proto._compileVisibleColumnsCore = function() {
        ...
        var expandColumns = (0, _module_utils2.mergeColumns)(that, that.getExpandColumns(), that._columns);
        var columns = (0, _module_utils2.mergeColumns)(that, that._columns, that._commandColumns, true);
        var columnDigitsCount = (0, _module_utils2.digitsCount)(columns.length);
        (0, _module_utils2.processBandColumns)(that, columns, bandColumnsCache);
        for (i = 0; i < rowCount; i++) {
            ...
            var indexedColumns;
            var parentBandColumns = (0, _module_utils2.getParentBandColumns)(this.index, bandColumnsCache.columnParentByIndex);
            ...
            if (visible && (!(0, _type.isDefined)(this.groupIndex) || this.showWhenGrouped)) {
                ...
                if (visibleIndex < 0) {
                    ...
                    if (this.fixed) {
                        ...
                        if (rtlEnabled && (!this.command || (0, _module_utils2.isCustomCommandColumn)(that, this))) {
                ...
                if (parentBandColumns.length) {
                    visibleIndex = (0, _module_utils2.numberToString)(visibleIndex, columnDigitsCount);
                    for (i = parentBandColumns.length - 1; i >= 0; i--) {
                        visibleIndex = (0, _module_utils2.numberToString)(parentBandColumns[i].visibleIndex, columnDigitsCount) + visibleIndex
                    }
                }
        ...
        (0, _iterator.each)(result, (function(rowIndex) {
            ...
            if (rowspanExpandColumns < rowIndex + 1) {
                rowspanExpandColumns += _module_utils2.processExpandColumns.call(that, result[rowIndex], expandColumns, "detailExpand", firstPositiveIndexColumn)
            }
            if (rowspanGroupColumns < rowIndex + 1) {
                rowspanGroupColumns += _module_utils2.processExpandColumns.call(that, result[rowIndex], expandColumns, _const.GROUP_COMMAND_COLUMN_NAME, firstPositiveIndexColumn)
            }
        }));
        result.push((0, _module_utils2.getDataColumns)(result));
    ...
    _proto.getChooserColumns = function(getAllColumns) {
        ...
        return (0, _module_utils2.sortColumns)(columnChooserColumns, sortOrder)
    };
    _proto.allowMoveColumn = function(fromVisibleIndex, toVisibleIndex, sourceLocation, targetLocation) {
        var columnIndex = (0, _module_utils2.getColumnIndexByVisibleIndex)(this, fromVisibleIndex, sourceLocation);
    ...
    _proto.moveColumn = function(fromVisibleIndex, toVisibleIndex, sourceLocation, targetLocation) {
        var options = {};
        var prevGroupIndex;
        var fromIndex = (0, _module_utils2.getColumnIndexByVisibleIndex)(this, fromVisibleIndex, sourceLocation);
        var toIndex = (0, _module_utils2.getColumnIndexByVisibleIndex)(this, toVisibleIndex, targetLocation);
        ...
        if (fromIndex >= 0) {
            ...
            if ((0, _type.isDefined)(column.groupIndex) && sourceLocation === _const.GROUP_LOCATION) {
                ...
                if (targetLocation !== _const.GROUP_LOCATION) {
                    ...
                    (0, _module_utils2.updateColumnGroupIndexes)(this)
                }
            }
            if (targetLocation === _const.GROUP_LOCATION) {
                options.groupIndex = (0, _module_utils2.moveColumnToGroup)(this, column, targetGroupIndex);
                column.groupIndex = prevGroupIndex
            } else if (toVisibleIndex >= 0) {
                var targetColumn = this._columns[toIndex];
                if (!targetColumn || column.ownerBand !== targetColumn.ownerBand) {
                    options.visibleIndex = _const.MAX_SAFE_INTEGER
                } else if ((0, _module_utils2.isColumnFixed)(this, column) ^ (0, _module_utils2.isColumnFixed)(this, targetColumn)) {
                    options.visibleIndex = _const.MAX_SAFE_INTEGER
                } else {
    ...
    _proto.changeSortOrder = function(columnIndex, sortOrder) {
        ...
        if (allowSorting && column && column.allowSorting) {
            ...
            if ((0, _module_utils2.isSortOrderValid)(sortOrder)) {
    ...
    _proto.refresh = function(updateNewLookupsOnly) {
        ...
        return _deferred.when.apply(_renderer.default, deferreds).done(_module_utils2.resetColumnsCache.bind(null, this))
    };
    _proto._updateColumnOptions = function(column, columnIndex) {
        ...
        }(0, _module_utils2.updateSerializers)(column, column.dataType);
        var lookup = column.lookup;
        if (lookup) {
            (0, _module_utils2.updateSerializers)(lookup, lookup.dataType)
        }
        var dataType = lookup ? lookup.dataType : column.dataType;
        if (dataType) {
            column.alignment = column.alignment || (0, _module_utils2.getAlignmentByDataType)(dataType, this.option("rtlEnabled"));
            column.format = column.format || _module_utils.default.getFormatByDataType(dataType);
            column.customizeText = column.customizeText || (0, _module_utils2.getCustomizeTextByDataType)(dataType);
            ...
            if (!(0, _type.isDefined)(column.filterOperations)) {
                (0, _module_utils2.setFilterOperationsAsDefaultValues)(column)
            }
    ...
    _proto.updateColumnDataTypes = function(dataSource) {
        ...
        (0, _iterator.each)(that._columns, (function(index, column) {
            ...
            var valueDataType;
            var lookup = column.lookup;
            if (_module_utils.default.isDateType(column.dataType) && void 0 === column.serializationFormat) {
                column.serializationFormat = dateSerializationFormat
            }
            if (lookup && _module_utils.default.isDateType(lookup.dataType) && void 0 === column.serializationFormat) {
            ...
            if (column.calculateCellValue && firstItems.length) {
                if (!column.dataType || lookup && !lookup.dataType) {
                    for (i = 0; i < firstItems.length; i++) {
                        ...
                        if (!column.dataType) {
                            valueDataType = (0, _module_utils2.getValueDataType)(value);
                        ...
                        if (lookup && !lookup.dataType) {
                            valueDataType = (0, _module_utils2.getValueDataType)(_module_utils.default.getDisplayValue(column, value, firstItems[i]));
                ...
                if (void 0 === column.serializationFormat || lookup && void 0 === lookup.serializationFormat) {
                    for (i = 0; i < firstItems.length; i++) {
                        ...
                        if (void 0 === column.serializationFormat) {
                            column.serializationFormat = (0, _module_utils2.getSerializationFormat)(column.dataType, value)
                        }
                        if (lookup && void 0 === lookup.serializationFormat) {
                            lookup.serializationFormat = (0, _module_utils2.getSerializationFormat)(lookup.dataType, lookup.calculateCellValue(value, true))
                        }
                    }
                }
            }
    ...
    _proto._customizeColumns = function(columns) {
        ...
        if (customizeColumns) {
            ...
            (0, _module_utils2.assignColumns)(this, (0, _module_utils2.createColumnsFromOptions)(this, columns))
        }
    };
    _proto.updateColumns = function(dataSource, forceApplying, isApplyingUserState) {
        ...
        if (!dataSource || dataSource.isLoaded()) {
            ...
            return (0, _deferred.when)(this.refresh(true)).always((function() {
                ...
                (0, _module_utils2.fireColumnsChanged)(_this)
            }))
        }
    };
    _proto._updateChanges = function(dataSource, parameters) {
        ...
        if (!_module_utils.default.equalSortParameters(parameters.sorting, this.getSortDataSourceParameters())) {
            (0, _module_utils2.updateColumnChanges)(this, "sorting")
        }
        if (!_module_utils.default.equalSortParameters(parameters.grouping, this.getGroupDataSourceParameters())) {
            (0, _module_utils2.updateColumnChanges)(this, "grouping")
        }
        var dataController = this.getController("data");
        if (dataController && !_module_utils.default.equalFilterParameters(parameters.filtering, dataController.getCombinedFilter())) {
            (0, _module_utils2.updateColumnChanges)(this, "filtering")
        }(0, _module_utils2.updateColumnChanges)(this, "columns")
    };
    _proto.updateSortingGrouping = function(dataSource, fromDataSource) {
        ...
        if (dataSource) {
            sortParameters = _module_utils.default.normalizeSortingInfo(dataSource.sort());
            var groupParameters = _module_utils.default.normalizeSortingInfo(dataSource.group());
            var columnsGroupParameters = that.getGroupDataSourceParameters();
            var columnsSortParameters = that.getSortDataSourceParameters();
            var groupingChanged = !_module_utils.default.equalSortParameters(groupParameters, columnsGroupParameters, true);
            var groupExpandingChanged = !groupingChanged && !_module_utils.default.equalSortParameters(groupParameters, columnsGroupParameters);
            if (!that._columns.length) {
                ...
                (0, _module_utils2.assignColumns)(that, (0, _module_utils2.createColumnsFromOptions)(that, that._columns))
            }
            if ((fromDataSource || !columnsGroupParameters && !that._hasUserState) && (groupingChanged || groupExpandingChanged)) {
                ...
                if (fromDataSource) {
                    groupingChanged && (0, _module_utils2.updateColumnChanges)(that, "grouping");
                    groupExpandingChanged && (0, _module_utils2.updateColumnChanges)(that, "groupExpanding");
                    isColumnsChanged = true
                }
            }
            if ((fromDataSource || !columnsSortParameters && !that._hasUserState) && !_module_utils.default.equalSortParameters(sortParameters, columnsSortParameters)) {
                that.__sortingUpdated = true;
                updateSortGroupParameterIndexes(that._columns, sortParameters, "sortIndex");
                if (fromDataSource) {
                    (0, _module_utils2.updateColumnChanges)(that, "sorting");
                    isColumnsChanged = true
                }
            }
            if (isColumnsChanged) {
                (0, _module_utils2.fireColumnsChanged)(that)
            }
        }
    };
    ...
    _proto.columnOption = function(identifier, option, value, notFireEvent) {
        ...
        var column = (0, _module_utils2.findColumn)(columns, identifier);
        if (column) {
            ...
            if ((0, _type.isString)(option)) {
                if (2 === arguments.length) {
                    return (0, _module_utils2.columnOptionCore)(that, column, option)
                }(0, _module_utils2.columnOptionCore)(that, column, option, value, notFireEvent)
            } else if ((0, _type.isObject)(option)) {
                (0, _iterator.each)(option, (function(optionName, value) {
                    (0, _module_utils2.columnOptionCore)(that, column, optionName, value, notFireEvent)
                }))
            }(0, _module_utils2.fireColumnsChanged)(that)
        }
    };
    _proto.clearSorting = function() {
        ...
        for (var i = 0; i < columnCount; i++) {
            ...
            delete(0, _module_utils2.findColumn)(this._columns, i).sortOrder
        }
        this.endUpdate()
    };
    ...
    _proto.addColumn = function(options) {
        var column = (0, _module_utils2.createColumn)(this, options);
        var index = this._columns.length;
        this._columns.push(column);
        if (column.isBand) {
            this._columns = (0, _module_utils2.createColumnsFromOptions)(this, this._columns);
            column = this._columns[index]
        }
        column.added = options;
        (0, _module_utils2.updateIndexes)(this, column);
    ...
    _proto.deleteColumn = function(id) {
        ...
        if (column && column.index >= 0) {
            (0, _module_utils2.convertOwnerBandToColumnReference)(this._columns);
        ...
        if (dataField) {
            if ((0, _type.isString)(dataField)) {
                ...
                calculatedColumnOptions = {
                    ...
                    setCellValue: _module_utils2.defaultSetCellValue,
                    parseValue: function(text) {
                        var result;
                        var parsedValue;
                        if ("number" === this.dataType) {
                            if ((0, _type.isString)(text) && this.format) {
                                result = (0, _module_utils2.strictParseNumber)(text.trim(), this.format)
                        ...
                        } else if (_module_utils.default.isDateType(this.dataType)) {
                ...
                updateValueMap: function() {
                    ...
                    if (this.items) {
                        ...
                        for (var i = 0; i < this.items.length; i++) {
                            ...
                            this.dataType = this.dataType || (0, _module_utils2.getValueDataType)(displayValue)
                        }
                    }
                },
                update: function() {
    ...
    _proto.getRowCount = function() {
        this._rowCount = this._rowCount || (0, _module_utils2.getRowCount)(this);
        return this._rowCount
    };
    _proto.getRowIndex = function(columnIndex, alwaysGetRowIndex) {
        var column = this._columns[columnIndex];
        var bandColumnsCache = this.getBandColumnsCache();
        return column && (alwaysGetRowIndex || column.visible && !(column.command || (0, _type.isDefined)(column.groupIndex))) ? (0, _module_utils2.getParentBandColumns)(columnIndex, bandColumnsCache.columnParentByIndex).length : 0
    };
    _proto.getChildrenByBandColumn = function(bandColumnIndex, onlyVisibleDirectChildren) {
        var bandColumnsCache = this.getBandColumnsCache();
        var result = (0, _module_utils2.getChildrenByBandColumn)(bandColumnIndex, bandColumnsCache.columnChildrenByIndex, !onlyVisibleDirectChildren);
    ...
    _proto.isParentBandColumn = function(columnIndex, bandColumnIndex) {
        ...
        var column = this._columns[columnIndex];
        var bandColumnsCache = this.getBandColumnsCache();
        var parentBandColumns = column && (0, _module_utils2.getParentBandColumns)(columnIndex, bandColumnsCache.columnParentByIndex);
    ...
    _proto.isParentColumnVisible = function(columnIndex) {
        var result = true;
        var bandColumnsCache = this.getBandColumnsCache();
        var bandColumns = columnIndex >= 0 && (0, _module_utils2.getParentBandColumns)(columnIndex, bandColumnsCache.columnParentByIndex);
    ...
    _proto.getColumnId = function(column) {
        if (column.command && column.type === _const.GROUP_COMMAND_COLUMN_NAME) {
            if ((0, _module_utils2.isCustomCommandColumn)(this, column)) {
    ...
    _proto.getCustomizeTextByDataType = function(dataType) {
        return (0, _module_utils2.getCustomizeTextByDataType)(dataType)
    };
