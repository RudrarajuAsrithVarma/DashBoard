/**
 * DevExtreme (cjs/__internal/grids/grid_core/grid_view/module.js)
 * Version: 23.1.3
...
var resizingControllerMembers = {
    ...
    _setAriaRowColCount: function() {
        ...
        }, component.$element().children(".".concat(GRIDBASE_CONTAINER_CLASS)))
    },
    ...
    _toggleContentMinHeight: function(value) {
        ...
        if (false === (null === scrollable || void 0 === scrollable ? void 0 : scrollable.option("useNative"))) {
            $contentElement.css({
                minHeight: value ? _module_utils.default.getContentHeightLimit(_browser.default) : ""
            })
        }
    },
    _synchronizeColumns: function() {
        ...
        if (needBestFit) {
            ...
            selectionRange = _module_utils.default.getSelectionRange(focusedElement);
    ...
    _correctColumnWidths: function(resultWidths, visibleColumns) {
        ...
        if (!hasAutoWidth && resultWidths.length) {
            ...
            if (totalWidth < contentWidth) {
                var lastColumnIndex = _module_utils.default.getLastResizableColumnIndex(visibleColumns, resultWidths);
    ...
    _waitAsyncTemplates: function() {
        var _a, _b, _c;
        return (0, _deferred.when)(null === (_a = this._columnHeadersView) || void 0 === _a ? void 0 : _a.waitAsyncTemplates(), null === (_b = this._rowsView) || void 0 === _b ? void 0 : _b.waitAsyncTemplates(), null === (_c = this._footerView) || void 0 === _c ? void 0 : _c.waitAsyncTemplates())
    },
    resize: function() {
        var _this4 = this;
...
var ResizingController = _modules.default.ViewController.inherit(resizingControllerMembers);
var SynchronizeScrollingController = _modules.default.ViewController.inherit({
...
var GridView = _modules.default.View.inherit({
