/**
 * DevExtreme (cjs/__internal/grids/grid_core/header_filter/module_core.js)
 * Version: 23.1.3
...
var HeaderFilterView = _modules.default.View.inherit({
            ...
            that._listComponent = that._createComponent((0, _renderer.default)("<div>").appendTo($content), _list_light.default, (0, _extend.extend)(widgetOptions, {
                ...
                onSelectionChanged: function(e) {
                    ...
                    if (!e.component._selectedItemsUpdating && !e.component.option("searchValue") && !options.isFilterBuilder) {
                        ...
                        var selected = _module_utils.default.getIndexByKey(item, selectedItems, null) >= 0;
                        var oldSelected = !!item.selected;
                        if (oldSelected !== selected) {
                            item.selected = selected;
                            options.filterValues = options.filterValues || [];
                            var filterValueIndex = _module_utils.default.getIndexByKey(item.value, options.filterValues, null);
