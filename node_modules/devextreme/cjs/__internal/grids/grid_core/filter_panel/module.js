/**
 * DevExtreme (cjs/__internal/grids/grid_core/filter_panel/module.js)
 * Version: 23.1.3
...
var _module_accessibility = require("../module_accessibility");
...
var FilterPanelView = _modules.default.View.inherit({
    isVisible: function() {
    ...
    _getFilterElement: function() {
        ...
        (0, _module_accessibility.registerKeyboardAction)("filterPanel", that, $element, void 0, (function() {
            return that._showFilterBuilder()
        }));
    ...
    _getTextElement: function() {
        ...
        (0, _module_accessibility.registerKeyboardAction)("filterPanel", that, $textElement, void 0, (function() {
            return that._showFilterBuilder()
        }));
    ...
    _getRemoveButtonElement: function() {
        ...
        (0, _module_accessibility.registerKeyboardAction)("filterPanel", this, $element, void 0, clearFilterValue);
        that._addTabIndexToElement($element);
        return $element
    },
    ...
    _getValueText: function(field, customOperation, value) {
        ...
        if ((0, _type.isDefined)(value) || hasCustomOperation) {
            if (!hasCustomOperation && field.lookup) {
                ...
                var displayValue = Array.isArray(value) ? value : _module_utils.default.getDisplayValue(field, value, null);
