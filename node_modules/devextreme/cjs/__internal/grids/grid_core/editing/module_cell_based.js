/**
 * DevExtreme (cjs/__internal/grids/grid_core/editing/module_cell_based.js)
 * Version: 23.1.3
        ...
        controllers: {
            editing: {
                ...
                _saveEditDataInner: function() {
                    ...
                    return this.callBase.apply(this, arguments).always(null === deferred || void 0 === deferred ? void 0 : deferred.resolve)
                },
            ...
            rowsView: {
                _createTable: function() {
                    ...
                    if (editingController.isCellOrBatchEditMode() && this.option("editing.allowUpdating")) {
                        _events_engine.default.on($table, (0, _index.addNamespace)(_hold.default.name, "dxDataGridRowsView"), "td:not(.".concat(EDITOR_CELL_CLASS, ")"), this.createAction((function() {
