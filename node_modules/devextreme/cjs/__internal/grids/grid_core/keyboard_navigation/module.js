...
var KeyboardNavigationController = function(_modules$ViewControll) {
    ...
    _proto._spaceKeyHandler = function(eventArgs, isEditing) {
        ...
        if (this.option("selection") && "none" !== this.option("selection").mode && !isEditing) {
            var isFocusedRowElement = "row" === this._getElementType($target) && this.isRowFocusType() && (0, _module_utils2.isDataRow)($target);
    ...
    _proto._targetCellTabHandler = function(eventArgs, direction) {
        ...
        if (!(0, _module_utils2.isEditorCell)(this, $cell) && $lastInteractiveElement.length && eventTarget !== $lastInteractiveElement.get(0)) {
            ...
            if (void 0 === this._focusedCellPosition.rowIndex && (0, _renderer.default)(eventTarget).hasClass(_uiGrid_core.ROW_CLASS)) {
                this._updateFocusedCellPosition($cell)
            }
            elementType = this._getElementType(eventTarget);
            if (this.isRowFocusType()) {
                this.setCellFocusType();
                if ("row" === elementType && (0, _module_utils2.isDataRow)((0, _renderer.default)(eventTarget))) {
    ...
    _proto._beginFastEditing = function(originalEvent, isDeleting) {
        ...
        if (isDeleting) {
            ...
            if (fastEditingKey && (1 === fastEditingKey.length || fastEditingKey === _const.FAST_EDITING_DELETE_KEY)) {
    ...
    _proto._memoFireFocusedCellChanged = function($cell, rowIndex, columnIndex) {
    ...
    _proto._hasSkipRow = function($row) {
        ...
        return row && ("none" === row.style.display || $row.hasClass(this.addWidgetPrefix(_const.GROUP_FOOTER_CLASS)) || (0, _module_utils2.isDetailRow)($row) && !$row.hasClass(this.addWidgetPrefix(_uiGrid_core.EDIT_FORM_CLASS)))
    };
