...
var adaptiveColumnsControllerMembers = {
    ...
    _renderFormViewTemplate: function(item, cellOptions, $container) {
        ...
        var displayValue = _module_utils.default.getDisplayValue(column, value, rowData, cellOptions.rowType);
        var text = _module_utils.default.formatValue(displayValue, column);
...
var AdaptiveColumnsController = _modules.default.ViewController.inherit(adaptiveColumnsControllerMembers);
        ...
        controllers: {
            ...
            editing: {
                ...
                _beforeUpdateItems: function(rowIndices, rowIndex) {
                    if (!this._adaptiveController.isFormOrPopupEditMode() && this._adaptiveController.hasHiddenColumns()) {
                        ...
                        var oldExpandRowIndex = _module_utils.default.getIndexByKey(this._dataController.adaptiveExpandedKey(), items);
                ...
                _beforeCloseEditCellInBatchMode: function(rowIndices) {
                    ...
                    if (expandedKey) {
                        var rowIndex = _module_utils.default.getIndexByKey(expandedKey, this._dataController.items());
                        if (rowIndex > -1) {
            ...
            data: {
                _processItems: function(items, change) {
                    ...
                    var expandRowIndex = _module_utils.default.getIndexByKey(this._adaptiveExpandedKey, items);
                ...
                toggleExpandAdaptiveDetailRow: function(key, alwaysExpanded) {
                    var oldExpandLoadedRowIndex = _module_utils.default.getIndexByKey(this._adaptiveExpandedKey, this._items);
                    var newExpandLoadedRowIndex = _module_utils.default.getIndexByKey(key, this._items);
