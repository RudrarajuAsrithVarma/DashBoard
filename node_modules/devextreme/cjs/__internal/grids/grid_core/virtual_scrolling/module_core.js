/**
 * DevExtreme (cjs/__internal/grids/grid_core/virtual_scrolling/module_core.js)
 * Version: 23.1.3
...
var _module = require("../virtual_data_loader/module");
...
var VirtualScrollController = _class.default.inherit(function() {
    var members = {
        ctor: function(component, dataOptions, isVirtual) {
            ...
            this._dataLoader = new _module.VirtualDataLoader(this, this._dataOptions)
        },
        ...
        setContentItemSizes: function(sizes) {
            ...
            if (virtualItemsCount) {
                ...
                var contentHeightLimit = _module_utils.default.getContentHeightLimit(_browser.default);
